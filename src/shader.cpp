...
namespace gpr5300
{
	...
	void Shader::SetMatrix4(const std::string_view uniform, glm::mat4& matrix4) const
	{
	...
	void Shader::SetVector3(const std::string_view uniform, float x, float y, float z) const
	{
		const int uniformLocation = glGetUniformLocation(ID, uniform.data());
		glUniform3f(uniformLocation, x, y, z);
	}
	void Shader::SetVector3(const std::string& uniform, const glm::vec3& value) const
	{
